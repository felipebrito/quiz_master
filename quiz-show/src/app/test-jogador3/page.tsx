...
export default function TestJogador3() {
  ...
  useEffect(() => {
    ...
    playerSocket?.on('connect', () => {
      console.log('✅ Jogador 3 connected to socket server')
      setConnected(true)
      ...
      addMessage('👤 Registrando como Ana Silva...')
    })

    playerSocket?.on('disconnect', (reason) => {
      console.log('❌ Jogador 3 disconnected:', reason)
      setConnected(false)
      setRegistered(false)
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-center">🎮 Teste Jogador 3 - Ana Silva</h1>
        ...
        <div className="mt-4 text-center text-gray-400 text-sm">
          Esta página simula o Jogador 3 conectando ao jogo.<br/>
