...
export default function Jogador3Page() {
  ...
  useEffect(() => {
    ...
    if (socketInstance) {
      ...
      socketInstance.on('connect', () => {
        console.log('🔌 Jogador 3 conectado')
        setIsConnected(true)
      ...
      socketInstance.on('disconnect', () => {
        console.log('🔌 Jogador 3 desconectado')
  ...
  const handleAnswer = (answer: string) => {
    ...
    socket.emit('player:answer', {
      ...
      answer: answer,
      participantId: 'jogador3' // This should be the actual participant ID
    })
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-900 to-pink-900 text-white p-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2">🎮 Jogador 3</h1>
          <div className="flex items-center justify-center gap-4">
            ...
            {gameState.isActive && (
              <Badge className="bg-purple-600">Jogo Ativo</Badge>
            )}
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-300">
            Abra <a href="/jogador1" className="text-blue-400 hover:underline">Jogador 1</a> e <a href="/jogador2" className="text-blue-400 hover:underline">Jogador 2</a> em outras abas para testar o jogo
          </p>
        </div>
      </div>
    </main>
