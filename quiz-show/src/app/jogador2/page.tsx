      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-300">
            Abra <a href="/jogador1" className="text-blue-400 hover:underline">Jogador 1</a> e <a href="/jogador3" className="text-blue-400 hover:underline">Jogador 3</a> em outras abas para testar a sincronização
          </p>
        </div>
      </div>
    </main>
