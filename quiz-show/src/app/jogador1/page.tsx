  ...
  useEffect(() => {
    ...
    socketInstance.on('round:ended', (data: any) => {
      ...
      setGameState(prev => ({
        ...
        score: data.currentScores.find((p: any) => p.id === 'player1')?.score || prev.score
      }))
    })
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-blue-200">Aguarde enquanto estabelecemos a conexão</p>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <Card className="w-full max-w-md mx-4 bg-white/10 backdrop-blur-lg border-white/20">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-white">Jogador 1</CardTitle>
            <p className="text-blue-200">Aguardando início do jogo...</p>
          </CardHeader>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 p-4">
      ...
      <div className="text-center mb-6">
        <h1 className="text-4xl font-bold text-white mb-2">Jogador 1</h1>
