...
export default function Jogador1Page() {
  ...
  const handleAnswer = (answer: string) => {
    ...
    socket.emit('player:answer', {
      ...
      answer: answer,
      participantId: 'jogador1' // This should be the actual participant ID
    })
    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-900 to-purple-900 text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2">🎮 Jogador 1</h1>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-300">
            Abra <a href="/jogador2" className="text-blue-400 hover:underline">Jogador 2</a> e <a href="/jogador3" className="text-blue-400 hover:underline">Jogador 3</a> em outras abas para testar o jogo
          </p>
        </div>
      </div>
    </main>
